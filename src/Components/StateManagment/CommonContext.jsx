...
export const DataProvider = ({ children }) => {
  ...
  const getGroup1Report = async (group1_id) => {
    try {
      await axios
        .get(`https://api.powerbi.com/v1.0/myorg/groups/${group1_id}/reports`, {
          headers: {
        ...
        .then((response) => {
          if (response.status === 200) {
            ...
            setPortfolioData({
              ...portfolioData,
              id: response.data.value[1].id,
              embedUrl: response.data.value[1].embedUrl,
            });
  ...
  const getGroup2Report = async (group2_id) => {
    try {
      await axios
        .get(`https://api.powerbi.com/v1.0/myorg/groups/${group2_id}/reports`, {
          headers: {
            authorization: `Bearer ${localStorage.getItem("initialToken")}`,
          },
        })
